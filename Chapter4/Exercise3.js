...
function arrayToList(argArray){
  	var list;
  	var endList = argArray.length -1;
	for(; endList >= 0; endList--){
    	list = {value: argArray[endList], rest: list || null};
    }
  	return list;
}
...
function listToArray(obj){
	...
	if(obj.rest === null){
    	...
    	newArray.push(obj.value);
      	...
      	newArray = newArray.concat(listToArray(obj.rest));
    }
  	return newArray;
}
